...
public abstract class IPMScheme {
    @Nonnull
    ...
    @CheckForNull
    public static IPMScheme createInstance(@Nonnull String type, @Nonnull String value)
    {
        return CppProxy.createInstance(type,
                                       value);
    }

    private static final class CppProxy extends IPMScheme
    {
