...
auto NativeEncryptPackage::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
    ...
    assert(j != nullptr);
    const auto& data = ::djinni::JniClass<NativeEncryptPackage>::get();
    return {::djinni::Binary::toCpp(jniEnv, (jbyteArray)jniEnv->GetObjectField(j, data.field_keyPackage)),
            ::djinni::Binary::toCpp(jniEnv, (jbyteArray)jniEnv->GetObjectField(j, data.field_dataPackage))};
}
