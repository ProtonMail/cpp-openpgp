...
CJNIEXPORT jboolean JNICALL Java_ch_protonmail_android_utils_nativelib_OpenPgp_findKeyid(JNIEnv* jniEnv, jobject /*this*/, jstring j_encryptText, jstring j_privateKey)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
