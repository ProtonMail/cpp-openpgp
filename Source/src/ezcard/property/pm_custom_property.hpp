...
#ifndef pm_custom_property_hpp
#define pm_custom_property_hpp

#include <stdio.h>
#include "text_property.hpp"
#include "has_alt_Id.hpp"
#include "i_p_m_custom.hpp"

namespace ezvcard {

    class PMCustom : public TextProperty, public IPMCustom, HasAltId {
    public:
        typedef std::shared_ptr<PMCustom> Ptr;
         ...
         */
        PMCustom(const std::string& custom) : TextProperty(custom) {
