...
namespace ProtonMail {
    std::shared_ptr<IVCard> IVCard::create_instance() {
        return std::make_shared<ezvcard::VCard>(VCardVersion::V4_0());
    }
...
namespace ezvcard {
     ...
     */
    VCard::VCard(VCardVersion::Ptr version) :
    _version(version)
    {
     ...
     */
    std::shared_ptr<IVCardVersion> VCard::getVersion() {
        return _version;
    }
     ...
     */
    void VCard::setVersion(const std::shared_ptr<IVCardVersion> & version) {
        if ( auto convertedObj = std::dynamic_pointer_cast<VCardVersion>(version) ) {
            _version = convertedObj;
        }
    }
    
    void VCard::setVersion(const VCardVersion::Ptr& version) {
        _version = version;
    }
     ...
     */
    void VCard::addProperty(const VCardProperty::Ptr& property) {
        _properties.put(property->className(), property);
    }
    
    void VCard::clearProperties(const std::string& className) {
        _properties.removeAll(className);
    }
    ...
    //    }
    std::shared_ptr<IGender> VCard::getGender() {
        return getProperty<Gender>();
    }
    void VCard::setGender(const std::shared_ptr<IGender>& gender) {
        setProperty<IGender, Gender>(gender);
    }
    void VCard::clearGender() {
        clearProperties(Gender::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.9</a>
     */
    std::shared_ptr<IFormattedName> VCard::getFormattedName() {
        auto found = getProperty<FormattedName>();
        return found;
    }
    
    std::vector<std::shared_ptr<IEmail>> VCard::getEmails() {
        auto found = getProperties<Email, IEmail>();
        return found;
    }
     ...
     */
    RawProperty::Ptr VCard::getExtendedProperty() {
        auto found = getProperty<RawProperty>();
        return found;
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.9</a>
     */
    void VCard::setFormattedName(FormattedName::Ptr formattedName) {
        setProperty(formattedName->className(), formattedName);
    }
    
    void VCard::setFormattedName(const std::shared_ptr<IFormattedName> & formattedName) {
        setProperty<IFormattedName, FormattedName>(formattedName);
    }
    
    void VCard::clearFormattedName() {
        clearProperties(FormattedName::CLASSNAME);
    }
    
    void VCard::addEmail(const std::shared_ptr<IEmail> & email) {
        addProperty<IEmail, Email>(email);
    }
    
    void VCard::setEmails(const std::vector<std::shared_ptr<IEmail>> & emails) {
        setProperty<IEmail, Email>(emails);
    }
    
    void VCard::clearEmails() {
        clearProperties(Email::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.9</a>
     */
    std::shared_ptr<IStructuredName> VCard::getStructuredName() {
        auto found = getProperty<StructuredName>();
        return found;
    }
    
    
    void VCard::setStructuredName(const std::shared_ptr<IStructuredName> & name) {
        setProperty<IStructuredName, StructuredName>(name);
    }
    
    void VCard::clearStructuredName() {
        clearProperties(StructuredName::CLASSNAME);
    }
    //
    //    /**
    //     * <p>
     ...
     * @see <a href="http://tools.ietf.org/html/rfc2426#page-9">RFC 2426 p.9</a>
     */
//    std::vector<std::shared_ptr<INickname>> VCard::getNicknames() {
//        return getProperties<Nickname, INickname>();
//    }
     ...
     * @see <a href="http://tools.ietf.org/html/rfc2426#page-9">RFC 2426 p.9</a>
     */
    std::shared_ptr<INickname> VCard::getNickname() {
        return getProperty<Nickname>();
    }
    
    void VCard::setNickname(const std::shared_ptr<INickname> & nickname) {
        setProperty<INickname, Nickname>(nickname);
    }
    
    void VCard::clearNickname() {
        clearProperties(Nickname::CLASSNAME);
    }
     ...
     */
    std::vector<Title::Ptr> VCard::getTitles() {
        return getProperties<Title>();
    }
    std::shared_ptr<ITitle> VCard::getTitle() {
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.17</a>
     */
    void VCard::addTitle(const Title::Ptr& title) {
        addProperty(title);
    }
    
    
    void VCard::setTitle(const std::shared_ptr<ITitle> & title) {
        setProperty<ITitle, Title>(title);
    }
    
    void VCard::clearTitle() {
        clearProperties(Title::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.10</a>
     */
    void VCard::addPhoto(Photo::Ptr photo) {
        addProperty(photo);
    }
    //
    //    /**
     ...
     */
    std::vector<std::shared_ptr<IBirthday>> VCard::getBirthdays() {
        auto found = getProperties<Birthday, IBirthday>();
        return found;
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.11</a>
     */
    std::shared_ptr<Birthday> VCard::getBirthday() {
        return getProperty<Birthday>();
    }
    
    void VCard::addBirthday(const std::shared_ptr<IBirthday> & birthday) {
        addProperty<IBirthday, Birthday>(birthday);
    }
    
    void VCard::setBirthdays(const std::vector<std::shared_ptr<IBirthday>> & birthdays) {
        setProperty<IBirthday, Birthday>(birthdays);
    }
    
    void VCard::clearBirthdays() {
        clearProperties(Birthday::CLASSNAME);
    }
    //    /**
    //     * <p>
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.11</a>
     */
    std::vector<std::shared_ptr<IAddress>> VCard::getAddresses() {
        auto found = getProperties<Address, IAddress>();
        return found;
    }
    ...
    void VCard::addAddress(const std::shared_ptr<IAddress>& addr) {
        addProperty<IAddress, Address>(addr);
    }
    
    void VCard::setAddresses(const std::vector<std::shared_ptr<IAddress>> & addrs) {
        setProperty<IAddress, Address>(addrs);
    }
    
    void VCard::clearAddresses() {
        clearProperties(Address::CLASSNAME);
    }
     ...
     */
    std::vector<std::shared_ptr<ITelephone>> VCard::getTelephoneNumbers() {
        auto found = getProperties<Telephone, ITelephone>();
        return found;
    }
    ...
    void VCard::addTelephone(const std::shared_ptr<ITelephone>& telephoneNumber) {
        addProperty<ITelephone, Telephone>(telephoneNumber);
    }
    
    void VCard::setTelephones(const std::vector<std::shared_ptr<ITelephone>> & cells) {
        setProperty<ITelephone, Telephone>(cells);
    }
    
    void VCard::clearTelephones() {
        clearProperties(Telephone::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.15</a>
     */
    Mailer::Ptr VCard::getMailer() {
        auto found = getProperty<Mailer>();
        return found;
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.15</a>
     */
    void VCard::setMailer(Mailer::Ptr mailer) {
        setProperty(mailer->className(), mailer);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.15</a>
     */
    Mailer::Ptr VCard::setMailer(const std::string& mailer) {
        Mailer::Ptr type = std::make_shared<Mailer>(mailer);
        setMailer(type);
        return type;
    }
     ...
     */
    std::vector<std::shared_ptr<IUrl>> VCard::getUrls() {
        auto found = getProperties<Url, IUrl>();
        return found;
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.21</a>
     */
    void VCard::addUrl(const std::shared_ptr<IUrl> & url) {
        addProperty<IUrl, Url>(url);
    }
    
    
    void VCard::setUrls(const std::vector<std::shared_ptr<IUrl>> & urls) {
        setProperty<IUrl, Url>(urls);
    }
    
    void VCard::clearUrls() {
        clearProperties(Url::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.19</a>
     */
    std::shared_ptr<IOrganization> VCard::getOrganization() {
        auto found = getProperty<Organization>();
        return found;
    }
    
    void VCard::addOrganization(const std::shared_ptr<IOrganization>& organization) {
        addProperty<IOrganization, Organization>(organization);
    }
    
    void VCard::setOrganizations(const std::vector<std::shared_ptr<IOrganization>> & orgs) {
        setProperty<IOrganization, Organization>(orgs);
    }
    
    void VCard::clearOrganizations() {
        clearProperties(Organization::CLASSNAME);
    }
    ...
    PMCustom::Ptr VCard::getPMCustom() {
        return getProperty<PMCustom>();
    }
    
    std::vector<PMCustom::Ptr> VCard::getPMCustoms() {
        return getProperties<PMCustom>();
    }
    
    std::vector<std::shared_ptr<IPMCustom>> VCard::getCustoms() {
        return getProperties<PMCustom, IPMCustom>();
    }
    
    void VCard::addCustom(const std::shared_ptr<IPMCustom> & custom) {
        addProperty<IPMCustom, PMCustom>(custom);
    }
    
    void VCard::setCustoms(const std::vector<std::shared_ptr<IPMCustom>> & customs) {
        setProperty<IPMCustom, PMCustom>(customs);
    }
    
    void VCard::clearCustoms() {
        clearProperties(PMCustom::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.19</a>
     */
    std::vector<Note::Ptr> VCard::getNotes() {
        return getProperties<Note>();
    }
    
    std::shared_ptr<INote> VCard::getNote() {
        return getProperty<Note>();
    }
    
    void VCard::setNote(const std::shared_ptr<INote> & note) {
        setProperty<INote, Note>(note);
    }
    
    void VCard::clearNote() {
        clearProperties(Note::CLASSNAME);
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.21</a>
     */
    std::shared_ptr<IUid> VCard::getUid() {
        auto found = getProperty<Uid>();
        return found;
    }
     ...
     * @see <a href="http://www.imc.org/pdi/vcard-21.doc">vCard 2.1 p.21</a>
     */
    void VCard::setUid(const Uid::Ptr& uid) {
        setProperty(uid->className(), uid);
    }
    
    void VCard::setUid(const std::shared_ptr<IUid> & uuid) {
        setProperty<IUid, Uid>(uuid);
    }
    //
    //    /**
    //     * <p>
    ...
    void VCard::addKey(const std::shared_ptr<IKey> & key) {
        addProperty<IKey, Key>(key);
    }
    
    void VCard::setKeys(const std::vector<std::shared_ptr<IKey>> & keys) {
        setProperty<IKey, Key>(keys);
    }
    
    void VCard::clearKeys() {
    ...
    void VCard::addPMSign(const std::shared_ptr<IPMSign> & sign) {
        addProperty<IPMSign, PMSign>(sign);
    }
    
    void VCard::setPMSign(const std::shared_ptr<IPMSign> & sign) {
        setProperty<IPMSign, PMSign>(sign);
    }
    
    void VCard::clearPMSign() {
    ...
    void VCard::setPMEncrypt(const std::shared_ptr<IPMEncrypt> & encrypt) {
        setProperty<IPMEncrypt, PMEncrypt>(encrypt);
    }
    
    void VCard::clearPMEncrypt() {
    ...
    void VCard::addPMScheme(const std::shared_ptr<IPMScheme> & scheme) {
        addProperty<IPMScheme, PMScheme>(scheme);
    }
    
    void VCard::setPMScheme(const std::shared_ptr<IPMScheme> & scheme) {
        setProperty<IPMScheme, PMScheme>(scheme);
    }

    void VCard::clearPMScheme() {
        clearProperties(PMScheme::CLASSNAME);
    }
     ...
     */
    //
    //    VCardProperty::Ptr VCard::getProperty(const std::string& className) {
    //        return _properties.first(className);
    //    }
    ...
    //     * {@link VCard} object and vice versa)
    //     */
    //    std::vector<VCardProperty::Ptr> VCard::getProperties(const std::string& className) {
    //        return _properties.get(className);
    //    }
     ...
     * @return the properties (this list is immutable)
     */
    std::vector<VCardProperty::Ptr> VCard::getProperties() {
     ...
     */
    std::vector<VCardProperty::Ptr> VCard::setProperty(const std::string& className, const VCardProperty::Ptr& property) {
        auto replaced = _properties.replace(className, property);
        return replaced;
    }
    
    
    std::vector<VCardProperty::Ptr> VCard::setProperty(const std::string& className, const std::vector<VCardProperty::Ptr>& properties) {
        auto replaced = _properties.replace(className, properties);
        return replaced;
    }
     ...
     * @return the properties that were replaced (this list is immutable)
     */
    std::vector<VCardProperty::Ptr> VCard::setProperty(const VCardProperty::Ptr& property) {
        return _properties.replace(property->className(), property);
    }
    ...
    std::vector<std::string> VCard::getPropertyTypes() {
