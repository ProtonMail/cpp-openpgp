...
std::vector <std::string> pka_sign(const std::string & digest, const uint8_t pka, const std::vector <std::string> & pub, const std::vector <std::string> & pri, const uint8_t h){
    if ((pka == 1) || (pka == 3)){ // RSA
        // RFC 4880 sec 5.2.2
...
std::vector <std::string> pka_sign(const std::string & digest, const Tag5::Ptr & tag5, const std::string & passphrase, const uint8_t h){
