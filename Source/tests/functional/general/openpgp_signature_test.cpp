...
namespace tests {
    namespace open_pgp_tests {
        ...
        {//Testing signature checking on CAST5-enciphered message
            ...
            TEST(checkint_cast5_enciphered_message) {
            ...
            TEST(testing_GnuPG_stripped_key_extensions) {
                ...
                PGPPublicKey pub_key(pub_key_arm1); //get pub key need to add function
                PGPMessage msg(msg_arm1);
...
//                return session_key;
            ...
            //    });
            //
            //    it("Verify signed message with two one pass signatures" "\n" function(done) {
            //        var msg_armor =
            //        [ "-----BEGIN PGP MESSAGE-----" "\n"
            //         "Version: GnuPG v2.0.19 (GNU/Linux)" "\n"
            //         "" "\n"
